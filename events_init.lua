...
function events_init.events_init_file(ui)
    ...
    local function file_file_list_item0_event_handler(e)
        ...
        -- No need to get ui from user_data, it's captured by the closure
    ...
    -- The last argument to add_event_cb is now nil because we are using closures.
    -- The 'ui' object is passed to the handlers via upvalues.
    lvgl.obj_add_event_cb(ui.file_file_list_item0, file_file_list_item0_event_handler, lvgl.EVENT_ALL, nil)
    lvgl.obj_add_event_cb(ui.file_operate_item4, file_operate_item4_event_handler, lvgl.EVENT_ALL, nil)
    lvgl.obj_add_event_cb(ui.file_operate_item5, file_operate_item5_event_handler, lvgl.EVENT_ALL, nil)
    lvgl.obj_add_event_cb(ui.file_btn_back, file_btn_back_event_handler, lvgl.EVENT_ALL, nil)
end
...
function events_init.events_init_edit(ui)
    ...
    lvgl.obj_add_event_cb(ui.edit_btn_back, edit_btn_back_event_handler, lvgl.EVENT_ALL, nil)
end
